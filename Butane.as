package  {
	...
	public class Butane extends MovieClip implements IQuestion{
		
		private var hitSlot:Slot;
		
		public function Butane(x:Number, y:Number) {
			this.x=x;
			this.y=y;
			// constructor code
		}
		...
		public function isLegalDrop(dropObj:MovieClip):Boolean
		{
			...
			// C1 C2 C3 C4 H1 H2 H3 H4 H5 H6 H7 H8 H9 H10
		...
		{
			if(!slot_C1.isAvailable()&&!slot_C2.isAvailable()&&!slot_C3.isAvailable()&&!slot_C4.isAvailable()&&!slot_H1.isAvailable()&&!slot_H2.isAvailable()&&!slot_H3.isAvailable()&&!slot_H4.isAvailable()&&!slot_H5.isAvailable()&&!slot_H6.isAvailable()&&!slot_H7.isAvailable()&&!slot_H8.isAvailable()&&!slot_H9.isAvailable()&&!slot_H10.isAvailable())
			{
