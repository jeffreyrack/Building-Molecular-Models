package  {
	...
	public class Pentane extends MovieClip implements IQuestion{
		
		private var hitSlot:Slot;
		
		public function Pentane(x:Number, y:Number) {
			this.x=x;
			this.y=y;
			// constructor code
		}
		...
		public function isLegalDrop(dropObj:MovieClip):Boolean
		{
			...
			// C1 C2 C3 C4 C5 H1 H2 H3 H4 H5 H6 H7 H8 H9 H10 H11 H12
			...
			else if(slot_H5.hitTestObject(dropObj))
			{
				...
				{
					hitSlot = slot_H5;
					slot_H5.setElectronVisible(false,false,false,false,false,true,false,false);
			...
			else if(slot_H6.hitTestObject(dropObj))
			{
				...
				{
					hitSlot = slot_H6;
					slot_H6.setElectronVisible(false,false,true,false,false,false,false,false);
			...
			else if(slot_H11.hitTestObject(dropObj))
			{
				...
				else if((dropObj.symbol.text == "H"))
				{
					...
					slot_H11.setElectronColor(0x223077);
			...
			else if(slot_H12.hitTestObject(dropObj))
			{
				...
				else if((dropObj.symbol.text == "H"))
				{
					...
					slot_H12.setElectronColor(0x223077);
		...
		{
			if(!slot_C1.isAvailable()&&!slot_C2.isAvailable()&&!slot_C3.isAvailable()&&!slot_C4.isAvailable()&&!slot_C5.isAvailable()&&!slot_H1.isAvailable()&&!slot_H2.isAvailable()&&!slot_H3.isAvailable()&&!slot_H4.isAvailable()&&!slot_H5.isAvailable()&&!slot_H6.isAvailable()&&!slot_H7.isAvailable()&&!slot_H8.isAvailable()&&!slot_H9.isAvailable()&&!slot_H10.isAvailable()&&!slot_H11.isAvailable()&&!slot_H12.isAvailable())
			{
