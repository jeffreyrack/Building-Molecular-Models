package  {
	...
	public class Propane extends MovieClip implements IQuestion{
		
		private var hitSlot:Slot;
		
		public function Propane(x:Number, y:Number) {
			this.x=x;
			this.y=y;
			// constructor code
		}
		...
		public function isLegalDrop(dropObj:MovieClip):Boolean
		{
			...
			// C1 C2 C3 H1 H2 H3 H4 H5 H6 H7 H8
		...
		{
			if(!slot_C1.isAvailable()&&!slot_C2.isAvailable()&&!slot_C3.isAvailable()&&!slot_H1.isAvailable()&&!slot_H2.isAvailable()&&!slot_H3.isAvailable()&&!slot_H4.isAvailable()&&!slot_H5.isAvailable()&&!slot_H6.isAvailable()&&!slot_H7.isAvailable()&&!slot_H8.isAvailable())
			{
